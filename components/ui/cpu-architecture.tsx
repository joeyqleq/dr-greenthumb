...
const CpuArchitecture = ({
  ...
  return (
    ...
    >
      ...
      >
        {/* 1st */}
        <path d="M 10 20 h 179.5 q 5 0 5 5 v 30" />
        {/* 2nd */}
        <path d="M 380 10 h -169.7 q -5 0 -5 5 v 30" />
        {/* 3rd */}
        <path d="M 230 20 v 21.8 q 0 5 -5 5 h -10" />
        {/* 4th */}
        <path d="M 370 80 v -21.8 q 0 -5 -5 -5 h -150" />
        {/* 5th */}
        <path d="M 235 65 h 15 q 5 0 5 5 v 10 q 0 5 -5 5 h -39.8 q -5 0 -5 -5 v -20" />
        {/* 6th */}
        <path d="M 194.8 95 v -36" />
        {/* 7th */}
        <path d="M 188 88 v -15 q 0 -5 -5 -5 h -10 q -5 0 -5 -5 v -5 q 0 -5 5 -5 h 14" />
        {/* 8th */}
        <path d="M 30 30 h 125 q 5 0 5 5 v 6.5 q 0 5 5 5 h 20" />
      ...
      <g>
        {showCpuConnections && (
          <g fill="url(#cpu-connection-gradient)">
            <rect x="193" y="37" width="2.5" height="5" rx="0.7" />
            <rect x="204" y="37" width="2.5" height="5" rx="0.7" />
            <rect x="216.3" y="44" width="2.5" height="5" rx="0.7" transform="rotate(90 216.25 45.5)" />
            <rect x="222.8" y="44" width="2.5" height="5" rx="0.7" transform="rotate(90 216.25 45.5)" />
            <rect x="204" y="16" width="2.5" height="5" rx="0.7" transform="rotate(180 205.25 39.5)" />
            <rect x="214.5" y="16" width="2.5" height="5" rx="0.7" transform="rotate(180 205.25 39.5)" />
            <rect x="180" y="-13.6" width="2.5" height="5" rx="0.7" transform="rotate(270 215.25 19.5)" />
            <rect x="187" y="-13.6" width="2.5" height="5" rx="0.7" transform="rotate(270 215.25 19.5)" />
          </g>
        )}
        <rect x="185" y="40" width="30" height="20" rx="2" fill="#181818" filter="url(#cpu-light-shadow)" />
        <text
          x="192"
          y="52.5"
          fontSize="7"
      ...
      {/* Masks */}
      <defs>
        <mask id="cpu-mask-1"><path d="M 10 20 h 179.5 q 5 0 5 5 v 24" strokeWidth="0.5" stroke="white" /></mask>
        <mask id="cpu-mask-2"><path d="M 380 10 h -169.7 q -5 0 -5 5 v 24" strokeWidth="0.5" stroke="white" /></mask>
        <mask id="cpu-mask-3"><path d="M 230 20 v 21.8 q 0 5 -5 5 h -10" strokeWidth="0.5" stroke="white" /></mask>
        <mask id="cpu-mask-4"><path d="M 370 80 v -21.8 q 0 -5 -5 -5 h -150" strokeWidth="0.5" stroke="white" /></mask>
        <mask id="cpu-mask-5"><path d="M 235 65 h 15 q 5 0 5 5 v 10 q 0 5 -5 5 h -39.8 q -5 0 -5 -5 v -20" strokeWidth="0.5" stroke="white" /></mask>
        <mask id="cpu-mask-6"><path d="M 194.8 95 v -36" strokeWidth="0.5" stroke="white" /></mask>
        <mask id="cpu-mask-7"><path d="M 188 88 v -15 q 0 -5 -5 -5 h -10 q -5 0 -5 -5 v -5 q 0 -5 5 -5 h 14" strokeWidth="0.5" stroke="white" /></mask>
        <mask id="cpu-mask-8"><path d="M 30 30 h 125 q 5 0 5 5 v 6.5 q 0 5 5 5 h 20" strokeWidth="0.5" stroke="white" /></mask>
