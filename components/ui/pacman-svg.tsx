...
export default function PacmanSvg() {
  ...
  useEffect(() => {
    const rect = document.getElementById("pacman-svg-container")?.getBoundingClientRect();
    if (rect) {
  ...
  return (
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" width="231" height="289" viewBox="0 0 231 289" className="w-full h-auto drop-shadow-[0_0_15px_rgba(56,189,248,0.4)]">
        <defs>
          <linearGradient id="ghostGrad" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="var(--sky)" stopOpacity="0.8" />
            <stop offset="100%" stopColor="var(--acid)" stopOpacity="0.3" />
          </linearGradient>
        ...
        <foreignObject width="231" height="289" clipPath="url(#shapeClip)">
          <div className="w-full h-full cy-noise opacity-30 mix-blend-overlay"></div>
        </foreignObject>
        <path d="M230.809 115.385V249.411C230.809 269.923 214.985 287.282 194.495 288.411C184.544 288.949 175.364 285.718 168.26 280C159.746 273.154 147.769 273.461 139.178 280.23C132.638 285.384 124.381 288.462 115.379 288.462C106.377 288.462 98.1451 285.384 91.6055 280.23C82.912 273.385 70.9353 273.385 62.2415 280.23C55.7532 285.334 47.598 288.411 38.7246 288.462C17.4132 288.615 0 270.667 0 249.359V115.385C0 51.6667 51.6756 0 115.404 0C179.134 0 230.809 51.6667 230.809 115.385Z" fill="url(#ghostGrad)" />

        {/* Left Eye */}
        <ellipse cx="80" cy="120" rx="30" ry="35" fill="white" />
        <motion.ellipse
          rx="12"
          ry="15"
          fill="black"
        ...
        {/* Right Eye */}
        <ellipse cx="150" cy="120" rx="30" ry="35" fill="white" />
        <motion.ellipse
          rx="12"
          ry="15"
          fill="black"
